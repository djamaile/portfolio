...
const contactLinks = [
  ...
  {
    label: 'Email',
    href: 'mailto:hello@djamaile.dev',
    icon: (
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            Have a question, collaboration idea, or just want to chat about developer
            experience and cloud infrastructure? I'd love to hear from you.
          </p>
